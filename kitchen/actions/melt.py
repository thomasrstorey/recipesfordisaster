...
def execute(inputs, output):
    ...
    for objname in inputs:
        ...
        # TODO: chopped objects explode. test by splitting by loose parts,
        # #    and then changing the simulation to suit.
        addSoftbody(scn, obj)
