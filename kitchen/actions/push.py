...
def scaleObjectRandomZ(obj):
    ...
    # define the scale
    xscale = Matrix.Scale(random.random()*0.5,4,(1,0,0))
    yscale = Matrix.Scale(random.random()*0.5,4,(0,1,0))
    zscale = Matrix.Scale(random.random()*0.5,4,(0,0,1))
...
def main():
    ...
    print("pushing " + ", ".join(inputs))
    execute(inputs, output)
    print("pushed " + ", ".join(inputs))
