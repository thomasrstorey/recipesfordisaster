...
def bakeObject(scn, obj):
    ...
    mod.strength = -0.2
    mod.mid_level = 1.0
    batterTex = bpy.data.textures.new(name="displace",type="MARBLE")
    batterTex.type_recast()
    mod.texture = batterTex
    batterTex.marble_type = "SHARPER"
    batterTex.noise_basis_2 = "TRI"
    batterTex.noise_type = "HARD_NOISE"
    batterTex.noise_scale = 1.25 + random.random()*0.5
    batterTex.noise_depth = 0
    # bpy.ops.texture.new()
