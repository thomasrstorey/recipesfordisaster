...
def bakeObject(scn, obj):
    ...
    tex = bpy.data.textures.new(name="freeze", type="CLOUDS")
    ...
    tex.noise_scale = 0.05 + (random.random()*0.05)
    tex.noise_depth = 4
    tex.intensity = 0.6
    tex.contrast = 1.0
    ...
    mod.strength = -0.1
    mod.mid_level = 0.0
    batterTex = bpy.data.textures.new(name="displace",type="CLOUDS")
