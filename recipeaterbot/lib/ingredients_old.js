/*
ingredients.js
a list of ingredients for automated recipe generation
sources: dariusk/corpora, Wikipedia.
*/
...
module.exports = {
  ...
  spices : [
    ...
    "Ground Allspice",
    "Amarillo Aji Chiles",
    "Amarillo Aji Chile Powder",
    "Amchur",
    "Anaheim Dried Chiles",
    "Ancho Dried Chiles",
    "Ancho Flakes",
    "Ancho Powder",
    ...
    "Beef Brisket Rub",
    "Berbere",
    "Birdseye Dried Chiles",
    "Birdseye Chile Powder",
    "Black Cumin",
    "Black & White Peppercorn Blend",
    "Black Mustard Seed",
    "Black Peppercorns",
    "Black Coarse Pepper Grind",
    "Black Medium Pepper Grind",
    ...
    "Cacao Sugar",
    "Cajun Rub",
    "Cajun Salt Seasoning Free",
    "Cajun Turkey Rub",
    "California Dried Chiles",
    "Caraway Seed",
    "Cardamom Pods",
    "Caradamom Seed",
    ...
    "Cascabel Chiles",
    "Cayenne Pepper (Hot 90000 HU)",
    "Cayenne Pepper (Medium 35000 HU)",
    "Celery Salt",
    "Celery Seed",
    "Ceylon Cinnamon",
    ...
    "Chili El Powder Paso Hot",
    "Chili Hill Powder Country",
    "Chili Powder Mild",
    "Chili Sweet Powder",
    "Chimichurri",
    "Chinese Five Spice",
    "Chipotle Dried Chiles",
    "Chipotle Flakes",
    "Chipotle Honey Rub",
    ...
    "Curry Sweet Powder",
    "Madras Curry",
    "Maharajah Curry Style",
    "Vindaloo Curry",
    "Cyprus Black Flake Sea Salt",
    "De Arbol Chiles",
    "De Arbol Chile Flakes",
    ...
    "Fines Herbes",
    "Flippin' The Bird",
    "California Fort Worth Burger Seasoning",
    "Garam Masala",
    "Garlic Roasted Flakes",
    "California Garlic Herb Seasoning",
    "Garlic Granules",
    "California Garlic Roasted Granules",
    ...
    "Gumbo File Powder",
    "Habanero Chocolate Chiles",
    "Habanero Dried Chiles",
    "Habanero Flakes",
    "Habanero Garlic Pepper",
    "Habanero Hot Salt",
    "Habanero Powder",
    "Habanero Mango Rub",
    "Harissa",
    ...
    "Manazanillo Mexican Seasoning",
    "Maras Crushed Pepper",
    "Marjoram Leaf",
    "Mayan Coco",
    ...
    "New York Pizza Sauce Seasoning",
    "Nigella Seeds (Black Caraway)",
    "Hot North Carolina BBQ Rub",
    "Nutmeg",
    "Nutmeg Powder",
    "Onion Granules",
    "Onion Powder",
    "Minced Onion Roasted",
    ...
    "Peppercorn Beef Rub",
    "Black Peppercorns",
    "Black Peppercorns & White Blend",
    "Gourmet Peppercorns Mix",
    "Green Peppercorns",
    "Pink Peppercorns",
    "Sichuan Peppercorns",
    ...
    "Sicilian Sea Salt",
    "Smoked Applewood Pepper",
    "Smoked Bourbon Barrel Salt",
    "Smoked Mesquite Sea Salt",
    "Hot Smoked Paprika",
    "Sweet Smoked Paprika",
    "Smoked Tea Rub",
    "Smoky Citrus Salt",
